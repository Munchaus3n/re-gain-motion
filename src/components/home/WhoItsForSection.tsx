      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <AnimatedSection>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-charcoal leading-tight mb-4">Training That Fits Your Life</h2>
            <p className="text-muted-foreground font-body text-lg leading-relaxed">KUNERA is built for real people with real goals. No matter where you're starting from, there's a path here for you.</p>
          </AnimatedSection>
